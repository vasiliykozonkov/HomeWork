...
public class Character {
	...
	public String toString() {
		...
		if (weapon != null) sb.append("   ️ Оружие: ").append(weapon).append("\n");
		if (armor != null) sb.append("   🛡️ Броня: ").append(armor).append("\n");
		if (!skills.isEmpty()) sb.append("    Навыки: ").append(skills).append("\n");
		if (pet != null) sb.append("   🐾 Питомец: ").append(pet).append("\n");
		return sb.toString();
	}
